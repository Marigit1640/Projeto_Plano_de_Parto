        ...
        <div class="fixed bottom-4 left-0 w-full flex justify-center z-40">
          <div class="w-full max-w-sm px-6">
            <div class="flex items-center">
              ...
              <mat-icon class="mx-4 text-brand-purple opacity-100 text-[14px]">favorite_border</mat-icon>
              <div class="flex-1 h-px bg-brand-purple opacity-50"></div>
            </div>
            <p class="text-center mt-1 text-[11px] tracking-wide text-brand-purple opacity-115">
              UFSJ • CEFET-MG
            </p>
          </div>
        </div>
